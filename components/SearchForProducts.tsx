    ...
    <div className='flex justify-center items-center w-5/6 h-full'>
        <SearchBarOverlay>
            <div className='flex flex-col justify-between h-5/6 w-3/5'>
              ...
              <SearchBar setItem={setItem} styles={'rounded-lg w-full h-2/5 text-black bg-gray-200 relative placeholder:italic pl-3 placeholder:text-lg placeholder:sm:text-xl placeholder:md:text-2xl placeholder:lg:text-3xl placeholder:xl:text-4xl'} />
